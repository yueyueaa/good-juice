...
func (vcq *VideoCollectionQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (vcq *VideoCollectionQuery) FirstIDX(ctx context.Context) int {
...
func (vcq *VideoCollectionQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (vcq *VideoCollectionQuery) OnlyIDX(ctx context.Context) int {
...
func (vcq *VideoCollectionQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (vcq *VideoCollectionQuery) IDsX(ctx context.Context) []int {
	ids, err := vcq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (vcq *VideoCollectionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(videocollection.Table, videocollection.Columns, sqlgraph.NewFieldSpec(videocollection.FieldID, field.TypeInt))
	_spec.From = vcq.sql
