...
const (
	// Label holds the string label denoting the videometadata type in the database.
	...
	// Table holds the table name of the videometadata in the database.
	Table = "video_metadata"
)

// Columns holds all SQL columns for videometadata fields.
var Columns = []string{
	FieldID,
	FieldVideoID,
	FieldUserID,
...
var (
	// DefaultPublishAddress holds the default value on creation for the "publish_address" field.
	DefaultPublishAddress int32
...
// OrderOption defines the ordering options for the VideoMetadata queries.
