...
import (
	...
	"juice/app/user/internal/data/ent/migrate"
...
func (c *UserBaseInfoClient) UpdateOneID(id int) *UserBaseInfoUpdateOne {
...
func (c *UserBaseInfoClient) DeleteOneID(id int) *UserBaseInfoDeleteOne {
...
func (c *UserBaseInfoClient) Get(ctx context.Context, id int) (*UserBaseInfo, error) {
	return c.Query().Where(userbaseinfo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserBaseInfoClient) GetX(ctx context.Context, id int) *UserBaseInfo {
...
// UpdateOneID returns an update builder for the given id.
func (c *UserFollowInfoClient) UpdateOneID(id int) *UserFollowInfoUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *UserFollowInfoClient) DeleteOneID(id int) *UserFollowInfoDeleteOne {
...
func (c *UserFollowInfoClient) Get(ctx context.Context, id int) (*UserFollowInfo, error) {
	return c.Query().Where(userfollowinfo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserFollowInfoClient) GetX(ctx context.Context, id int) *UserFollowInfo {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *VideoCollectionClient) UpdateOneID(id int) *VideoCollectionUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *VideoCollectionClient) DeleteOneID(id int) *VideoCollectionDeleteOne {
...
func (c *VideoCollectionClient) Get(ctx context.Context, id int) (*VideoCollection, error) {
	return c.Query().Where(videocollection.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *VideoCollectionClient) GetX(ctx context.Context, id int) *VideoCollection {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *VideoCommentClient) UpdateOneID(id int) *VideoCommentUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *VideoCommentClient) DeleteOneID(id int) *VideoCommentDeleteOne {
...
func (c *VideoCommentClient) Get(ctx context.Context, id int) (*VideoComment, error) {
	return c.Query().Where(videocomment.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *VideoCommentClient) GetX(ctx context.Context, id int) *VideoComment {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *VideoLikeClient) UpdateOneID(id int) *VideoLikeUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *VideoLikeClient) DeleteOneID(id int) *VideoLikeDeleteOne {
...
func (c *VideoLikeClient) Get(ctx context.Context, id int) (*VideoLike, error) {
	return c.Query().Where(videolike.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *VideoLikeClient) GetX(ctx context.Context, id int) *VideoLike {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
