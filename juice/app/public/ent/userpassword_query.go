...
func (upq *UserPasswordQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (upq *UserPasswordQuery) FirstIDX(ctx context.Context) uint64 {
...
func (upq *UserPasswordQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (upq *UserPasswordQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (upq *UserPasswordQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (upq *UserPasswordQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := upq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (upq *UserPasswordQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(userpassword.Table, userpassword.Columns, sqlgraph.NewFieldSpec(userpassword.FieldID, field.TypeUint64))
	_spec.From = upq.sql
