...
import (
	...
	"juice/public/data/ent/videocollection"
	"time"
...
func (vcu *VideoCollectionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	_spec := sqlgraph.NewUpdateSpec(videocollection.Table, videocollection.Columns, sqlgraph.NewFieldSpec(videocollection.FieldID, field.TypeUint64))
