...
func (vcc *VideoCollectionCreate) SetID(u uint64) *VideoCollectionCreate {
...
func (vcc *VideoCollectionCreate) createSpec() (*VideoCollection, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(videocollection.Table, sqlgraph.NewFieldSpec(videocollection.FieldID, field.TypeUint64))
	)
