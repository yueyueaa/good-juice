...
func (vcq *VideoCommentQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (vcq *VideoCommentQuery) FirstIDX(ctx context.Context) uint64 {
...
func (vcq *VideoCommentQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (vcq *VideoCommentQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (vcq *VideoCommentQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (vcq *VideoCommentQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := vcq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (vcq *VideoCommentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(videocomment.Table, videocomment.Columns, sqlgraph.NewFieldSpec(videocomment.FieldID, field.TypeUint64))
	_spec.From = vcq.sql
