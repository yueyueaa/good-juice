...
func (ufic *UserFollowInfoCreate) SetID(u uint64) *UserFollowInfoCreate {
	ufic.mutation.SetID(u)
	return ufic
}
...
func (ufic *UserFollowInfoCreate) createSpec() (*UserFollowInfo, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userfollowinfo.Table, sqlgraph.NewFieldSpec(userfollowinfo.FieldID, field.TypeUint64))
	)
