...
func (tx *Tx) init() {
	tx.UserBaseInfo = NewUserBaseInfoClient(tx.config)
	tx.UserFollowInfo = NewUserFollowInfoClient(tx.config)
...
// applies a query, for example: UserBaseInfo.QueryXXX(), the query will be executed
