...
func (vlc *VideoLikeCreate) SetID(u uint64) *VideoLikeCreate {
...
func (vlc *VideoLikeCreate) createSpec() (*VideoLike, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(videolike.Table, sqlgraph.NewFieldSpec(videolike.FieldID, field.TypeUint64))
	)
