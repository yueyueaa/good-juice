...
func (upc *UserPasswordCreate) SetID(u uint64) *UserPasswordCreate {
...
func (upc *UserPasswordCreate) createSpec() (*UserPassword, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userpassword.Table, sqlgraph.NewFieldSpec(userpassword.FieldID, field.TypeUint64))
	)
