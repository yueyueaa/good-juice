...
func (vmc *VideoMetadatumCreate) SetID(i int) *VideoMetadatumCreate {
...
func (vmc *VideoMetadatumCreate) createSpec() (*VideoMetadatum, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(videometadatum.Table, sqlgraph.NewFieldSpec(videometadatum.FieldID, field.TypeInt))
	)
